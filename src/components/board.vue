  ...
  <div id="app">
    ...
    <fc-designer ref="designer" height="calc(100vh - 60px)">
      <template slot="handle">
        <ElButton @click="customClick">自定义按钮</ElButton>
      </template>
    </fc-designer>
...
import carousel from './customComponents/carousel.js';
...
export default {
  ...
  mounted() {
    this.$refs.designer.addComponent(carousel);
    this.$refs.designer.addComponent(badge);
